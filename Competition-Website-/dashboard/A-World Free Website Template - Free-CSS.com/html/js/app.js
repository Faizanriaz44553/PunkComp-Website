import {db, collection , getDocs , doc, getDoc ,auth ,  onAuthStateChanged , signOut} from "../../../../firebase.js"; 
    ...
    querySnapshot.forEach((doc) => {
      ...
      <div class="custom-card" onclick="detailView('${doc.id}')">
        ...
        <div class="custom-card-body">
          ...
          <p class="card-text">${Description.length > 100 ? Description.slice(0, 100) + '...' : Description}</p>
...
const ReviewSection = async () => {
  carouselInner.innerHTML = `<div class="loader-div"><span class="loader"></span></div>`
    try {
      ...
      if (docSnap.exists()) {
        const { Title1 , Title2 , Title3 , Description1 , Description2 , Description3 , Image1 , Image2 , Image3} = docSnap.data();
